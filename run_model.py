...
def forward_pass(model_name,image_name,style):
    ...
    blob_image=cv2.dnn.blobFromImage(image,1.0,size=(w,h),mean=(103.939, 116.779, 123.680),swapRB=False,crop=False)
    ...
    cv2.imwrite(STYLE_PATH+filename+style+file_extension,output)
    return output
